...
public class AssetScanRepository {

    private final AssetScanApi api;

    public AssetScanRepository(Context context) {
        this.api = ApiClient.getClient(context).create(AssetScanApi.class);
    }
    ...
    public void scanAsset(
        ...
        ScanRequest request = new ScanRequest(barcode, locationCode, "ASSET");
